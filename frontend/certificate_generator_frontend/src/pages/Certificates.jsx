...
//           {filtered.map(c => (
//             <div key={c._id} className="card p-4 bg-white">
//               <div className="font-semibold">{c.employee.name}</div>
...
//           ) : (
//             filtered.map(c => (
//               <div key={c._id} className="card p-4 bg-white shadow rounded-lg">
...
//                 {c.fileUrl && (
//                   <a
//                     className="link mt-2 inline-block text-white bg-[#008DC3] px-4 py-2 rounded hover:bg-[#0072A3]"
//                     href={
//                       c.fileUrl.startsWith("/outputs")
//                         ? c.fileUrl
//                         : `/${c.fileUrl}`
